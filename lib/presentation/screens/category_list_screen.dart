...
import 'package:nobel/presentation/screens/detail_screen.dart';
import 'package:nobel/common/theme/nobel_palette.dart';
import 'package:nobel/presentation/widgets/laureate_item.dart';
...
class _CategoryListScreenState extends ConsumerState<CategoryListScreen> {
  ...
  final List<LaureateModel> _totalList = [];
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index < _totalList.length) {
                        final LaureateModel currentLaureate = _totalList[index];
