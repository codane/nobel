...
mixin _$LaureatesState {
  List<Laureate> get laureatesList => throw _privateConstructorUsedError;
...
abstract class $LaureatesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Laureate> laureatesList});
}
...
class _$_LaureatesState implements _LaureatesState {
  _$_LaureatesState({final List<Laureate> laureatesList = const []})
      : _laureatesList = laureatesList;

  final List<Laureate> _laureatesList;
  @override
  @JsonKey()
  List<Laureate> get laureatesList {
...
abstract class _LaureatesState implements LaureatesState {
  factory _LaureatesState({final List<Laureate> laureatesList}) =
      _$_LaureatesState;
